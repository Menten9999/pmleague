          ...
          {archives.map((archive) => {
            ...
            return (
              <section key={archive.id} className="bg-[#111] border border-white/10 rounded-sm overflow-hidden">
                {/* シーズンタイトル */}
                <div className="bg-yellow-900/20 border-b border-yellow-600/30 p-6">
                  <h2 className="text-3xl font-black italic text-yellow-500 tracking-wider">
                    {archive.title}
                  </h2>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {teams.map((team: any, index: number) => (
                        <div key={team.id} className="flex items-center justify-between bg-black/50 p-3 border border-white/5 rounded-sm relative overflow-hidden">
                          ...
                          <div className="flex items-center gap-3 pl-3">
                            ...
                            <span className="font-bold tracking-wider">{team.name}</span>
                          </div>
